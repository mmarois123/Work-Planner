...
- [ ] Project added contract-item volume from new South & Rochester space — needs input from Frank, then project the incremental spend (req. 6/19, "Summary of Savings")
...
## Irina (Direct Report)
- [ ] AR Payment Report — build in Fabric Apps; use LLM co-development @delegated(Irina)
- [ ] Obtain access to Paylocity reporting; explore available reports, data, and fields ahead of API access @delegated(Irina)
...
- [x] Weekly Operations Report (recur: weekly@Mon) (due: 2026-06-29)
...
- [ ] Quarterly BoD Presentation (recur: quarterly@bod-2) (due: 2026-07-21)
  - due not set — set the "Next BoD meeting" anchor above
